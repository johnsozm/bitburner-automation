...
export async function main(ns) {
    ...
    while (true) {
        ...
        const hackAscend = ascensionResults == null ? false : ascensionResults.hack >= 1.5 * stats.hack_asc_mult;
        const combatAscend = ascensionResults == null ? false : (ascensionResults.agi >= 1.5 * stats.agi_asc_mult)
                            && (ascensionResults.def >= 1.5 * stats.def_asc_mult)
                            && (ascensionResults.dex >= 1.5 * stats.dex_asc_mult)
                            && (ascensionResults.str >= 1.5 * stats.str_asc_mult);
